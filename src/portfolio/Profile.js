        ...
        {!loading && profile.id && !(
          ...
          >
            ...
            <div>
              ...
              <p className="text-amber-700 text-xs mt-0.5">Please add your full name, headline, summary, education, skills, and experience (if applicable) to complete your portfolio.</p>
            </div>
          </motion.div>
        )}
