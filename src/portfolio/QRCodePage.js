...
const QRCodePage = () => {
  ...
  const [qrColor, setQrColor] = useState("#059669"); // Default Emerald Green color

  // Theme presets for QR code
  const colorPresets = [
    { name: "Emerald Green", value: "#059669", bg: "bg-[#059669]" },
    { name: "Teal Dark", value: "#064e3b", bg: "bg-[#064e3b]" },
    { name: "Brand Emerald", value: "#10B981", bg: "bg-[#10B981]" },
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 bg-slate-50 border border-slate-200/60 rounded-2xl p-2.5 w-full">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  >
                    {copied ? <FaCheck className="text-emerald-500" /> : <FaCopy className="text-emerald-600" />}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-emerald-600/15 active:scale-95"
                  >
            ...
            <div className="pt-4 border-t border-slate-100">
              <h2 className="text-sm font-black text-slate-800 mb-3 flex items-center gap-2">
                <FaPalette className="text-emerald-600 w-4 h-4" /> Customize QR Color
              </h2>
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3.5">
              <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-1.5">
                <FaInfoCircle className="text-emerald-500 w-3.5 h-3.5" /> Best Integration Practices
              </h3>
        ...
        <div className="lg:col-span-5 flex flex-col justify-start">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col justify-between items-center text-center space-y-6">
            <div className="w-full text-left">
              <span className="px-2.5 py-1 bg-emerald-50 border border-emerald-100 text-emerald-600 text-[9px] font-black uppercase tracking-widest rounded-full">
                Interactive Preview
              </span>
            </div>
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex flex-col items-center justify-center shadow-inner relative overflow-hidden w-full max-w-[280px]">
              <div className="absolute top-0 right-0 w-[80px] h-[80px] rounded-full bg-emerald-500/5 blur-[20px] pointer-events-none"></div>
            ...
            <div className="w-full flex flex-col gap-2.5">
              <button
                ...
                className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black transition-all flex items-center justify-center gap-2 active:scale-95 shadow-md shadow-emerald-600/15 hover:shadow-lg hover:shadow-emerald-600/25 cursor-pointer"
              >
